  ...
  <div class="ds-wrap">
    ...
    <div class="pc-quicklinks">
      <a href="tel:+916362616933" class="pc-quick">
        <span class="pc-quick-icon"><?php echo hb_icon( 'phone', 20 ); ?></span>
      ...
      <div class="pc-quick">
        <span class="pc-quick-icon"><?php echo hb_icon( 'clock', 20 ); ?></span>
        <span class="pc-quick-text">
      ...
      <div class="pc-info">
        ...
        <div class="pc-info-list">
          <div class="ds-card pc-info-item">
            <div class="pc-info-icon"><?php echo hb_icon( 'pin', 22 ); ?></div>
            <div>
              <h3>Our Address</h3>
          ...
          <div class="ds-card pc-info-item">
            <div class="pc-info-icon"><?php echo hb_icon( 'phone', 22 ); ?></div>
            <div>
              <h3>Phone</h3>
          ...
          <div class="ds-card pc-info-item">
            <div class="pc-info-icon"><?php echo hb_icon( 'mail', 22 ); ?></div>
            <div>
              <h3>Email</h3>
          ...
          <div class="ds-card pc-info-item">
            <div class="pc-info-icon"><?php echo hb_icon( 'clock', 22 ); ?></div>
            <div>
        ...
        <div class="ds-card pc-cert">
          <div class="pc-cert-icon"><?php echo hb_icon( 'shield', 22 ); ?></div>
          <div>
