...
<section style="padding:80px 20px;background:#FFF8F0;">
...
.faq-q:hover,.faq-item.open .faq-q{background:#FFF8F0;color:#8B4513}
.faq-icon{color:#8B4513;font-size:1.4rem;transition:transform .3s;flex-shrink:0;margin-left:16px}
...
.faq-cat-title{font-family:Georgia,serif;font-size:1.5rem;color:#8B4513;margin:0 0 20px;padding-bottom:12px;border-bottom:2px solid #D4A017}
...
<div style="background:#8B4513;border-radius:16px;padding:48px;text-align:center;color:#fff;margin-top:20px;">
